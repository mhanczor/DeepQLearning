...
class QNetwork(object):
    ...
    def __init__(self, environment, alpha=0.0001, gamma=1):
        ...
        # What is the strategy for initialization?
            # Zeros everywhere
            # Gaussian?
...
class LinearQ(QNetwork):
    ...
    def __init__(self, environment, alpha=0.0001, gamma=1):
        ...
        # Initializing at zero to start
        self.w = np.zeros((self.nA*self.inputs + 1,1)) # Include bias
        self.lam = 0.001
...
class DQN_Agent(object):
    ...
    def __init__(self, environment, network_type, epsilon=0.5, render=False):
